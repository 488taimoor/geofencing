    ...
    return (
      <Container>
        <Header style={styles.header}>
          <Body>
            <Title style={styles.title}>Rolux Test App</Title>
          </Body>
        </Header>
        <Body style={styles.body}>
            ...
            <Button full style={styles.button} onPress={() => this.onClickNavigate('Advanced')}><Text>GeoFencing Advanced</Text></Button>
        </Body>
