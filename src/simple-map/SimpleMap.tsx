...
export default class SimpleMap extends Component<IProps, IState> {
  constructor(props:any) {
    ...
    this.addonemoreMarker=this.addonemoreMarker.bind(this);
  }
  ...
  */
  ...
  addMarker(location:Location) {
    console.log('this is locaiton', location)
    let marker = {
      key: location.uuid,
  ...
  addonemoreMarker(coordinates:any) {
    console.log('this is event', coordinates)
    let another = {
    ...
    this.setState({
      markers: [...this.state.markers,  another]
    },()=>{
      console.log('this is another marker', this.state.markers)
    });
    ...
    return (
      <Container style={styles.container}>
        ...
        <MapView
          ...
          onPress={ (event) => this.addonemoreMarker(event.nativeEvent.coordinate) }
          >
